...
CUSUM_THRESHOLD = 20 * 1.1
EXCLUDED_CONTROL_RUNS = {2, 10, 14, 17, 18, 19, 23, 29, 31, 33, 35, 37, 47, 51}
## EXCLUDED_CONTROL_RUNS = {2, 26, 49, 29, 35} ## bad runs from straight control
EXCLUDED_SPOOFED_RUNS = {2, 32, 36, 49, 50} ## bad runs from turn spoofing
...
## EXCLUDED_RUNS = [2, 26, 49, 29, 35] ## bad runs from straight control 
EXCLUDED_RUNS = [2, 13, 16, 26, 29, 35, 49, 50] ## bad runs from turn control 
